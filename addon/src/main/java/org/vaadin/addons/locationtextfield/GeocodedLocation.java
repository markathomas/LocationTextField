...
public class GeocodedLocation implements Serializable {
    ...
    /**
     * This should be the original input address to the {@link org.vaadin.addons.locationtextfield.LocationProvider}
     */
    ...
    /**
     * Should be true if the {@link org.vaadin.addons.locationtextfield.LocationProvider} returned more than one result for the input address
     */
